...
mod tests {
    ...
    // BEARER_CODE=xxx BOARD_ID=xxx SECTION_ID=xxx cargo test test_delete_boards_board_id_sections_section_id -- --nocapture --test-threads=1

    #[tokio::test]
    async fn test_delete_boards_board_id_sections_section_id() {
